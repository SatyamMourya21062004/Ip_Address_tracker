...
function App() {
    ...
    try {
      const getInitialData = async () => {
        const res = await fetch(
          `https://geo.ipify.org/api/v2/country,city?apiKey=at_n9P3Qh4VRzsaLoLh92fnqQWq9k063&ipAddress=8.8.8.8`
        )
  ...
  const getEnteredData = async () => {
    const res = await fetch(
      `https://geo.ipify.org/api/v2/country,city?apiKey=at_n9P3Qh4VRzsaLoLh92fnqQWq9k063&${
